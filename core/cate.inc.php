...
function getCateById($id){
	$sql="select id,catname,catdesc from dev_cate where id={$id}";
	return fetchOne($sql);
}
 ...
 */
function getAllCate(){
	$sql="select id,catname,catdesc from dev_cate";
	$rows=fetchAll($sql);
	return $rows;
}
...
function getCateInfo(){
	$sql="select id,catname,catdesc from dev_cate order by id asc";
	$rows=fetchAll($sql);
	return $rows;
}